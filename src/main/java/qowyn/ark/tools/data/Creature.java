...
public class Creature {
	...
	// FIXME add to write part
	public boolean isBaby;
	public Float babyAge;
	public Double babyNextCuddleTime;
	public Float babyGestationProgress;
	public Double lastUpdatedGestationAtTime;
	public Double lastUpdatedMatingAtTime;
	public boolean isNeutered;
	public Integer randomMutationsFemale;
	public Integer randomMutationsMale;
	public Integer gestationEggRandomMutationsFemale;
	public Integer gestationEggRandomMutationsMale;
	...
	public Creature(GameObject creature, GameObjectContainer container) {
		...
		isBaby = creature.findPropertyValue("bIsBaby", Boolean.class).orElse(Boolean.FALSE);
		babyAge = creature.findPropertyValue("BabyAge", Float.class).orElse(null);
		babyNextCuddleTime = creature.findPropertyValue("BabyNextCuddleTime", Double.class).orElse(null);
		babyGestationProgress = creature.findPropertyValue("BabyGestationProgress", Float.class).orElse(null);
		lastUpdatedGestationAtTime = creature.findPropertyValue("LastUpdatedGestationAtTime", Double.class).orElse(null);
		lastUpdatedMatingAtTime = creature.findPropertyValue("_lastUpdatedMatingAtTime", Double.class).orElse(null);
		isNeutered = creature.findPropertyValue("bNeutered", Boolean.class).orElse(Boolean.FALSE);
		randomMutationsFemale = creature.findPropertyValue("RandomMutationsFemale", Integer.class).orElse(null);
		randomMutationsMale = creature.findPropertyValue("RandomMutationsMale", Integer.class).orElse(null);
		gestationEggRandomMutationsFemale = creature.findPropertyValue("GestationEggRandomMutationsFemale", Integer.class).orElse(null);
		gestationEggRandomMutationsMale = creature.findPropertyValue("GestationEggRandomMutationsMale", Integer.class).orElse(null);
	}
